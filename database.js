  ...
  try {
    ...
    if (parseInt(existingCourses[0].count) === 0) {
      const defaultCourses = [
        { name: 'Ngữ Văn Lớp 6', short_name: 'LỚP 6', emoji: '📖', color: 'blue', sub: 'Nền tảng vững chắc', description: 'Làm quen với thể loại, kỹ năng kể chuyện, viết đoạn cảm thụ và phân tích nhân vật.', features: ['Làm quen các thể loại văn học','Rèn kỹ năng viết đoạn cảm thụ','Phân tích nhân vật cơ bản','Ôn tập kiểm tra thường xuyên'], duration: '2h/buổi', max_students: 'Tối đa 8', sessions: '2 buổi/tuần', status: 'available', sort_order: 1 },
        { name: 'Ngữ Văn Lớp 7', short_name: 'LỚP 7', emoji: '📝', color: 'green', sub: 'Nâng cao kỹ năng', description: 'Nâng cao phân tích tác phẩm, luyện văn nghị luận và biểu cảm thành thạo.', features: ['Phân tích tác phẩm chuyên sâu','Nghị luận & biểu cảm thành thạo','Viết bài hoàn chỉnh có cấu trúc','Luyện đề kiểm tra học kỳ'], duration: '2h/buổi', max_students: 'Tối đa 8', sessions: '2 buổi/tuần', status: 'available', sort_order: 2 },
        { name: 'Ngữ Văn Lớp 8', short_name: 'LỚP 8', emoji: '✍️', color: 'purple', sub: 'Bước đệm THPT', description: 'Chuẩn bị chuyển cấp, luyện nghị luận xã hội chuyên sâu, cảm thụ thơ và truyện.', features: ['Nghị luận xã hội chuyên sâu','Cảm thụ thơ & truyện hiện đại','Kỹ năng thi cử cấp THCS','Tư duy phản biện nâng cao'], duration: '2h/buổi', max_students: 'Tối đa 8', sessions: '2 buổi/tuần', status: 'available', sort_order: 3 },
        { name: 'Ngữ Văn Lớp 9', short_name: 'LỚP 9', emoji: '🎯', color: 'orange', sub: 'Ôn thi tốt nghiệp', description: 'Ôn tập toàn diện, luyện đề chuyên sâu cho kỳ thi tốt nghiệp THCS và vào lớp 10.', features: ['Ôn tập toàn diện chương trình','Luyện đề chuyên sânăm gần đây','Phương pháp làm bài nhanh','Chữa đề và nâng điểm'], duration: '2.5h/buổi', max_students: 'Tối đa 10', sessions: '3 buổi/tuần', status: 'available', sort_order: 4 },
      ];
